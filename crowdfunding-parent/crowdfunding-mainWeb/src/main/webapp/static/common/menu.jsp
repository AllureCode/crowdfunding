...
<%--        <ul style="margin-top:10px;display:none;">--%>
<%--            <li style="height:30px;">--%>
<%--                <a href="${APP_PATH}/user/toUser.html"><i class="glyphicon glyphicon-user"></i> 用户维护</a>--%>
<%--            </li>--%>
<%--            <li style="height:30px;">--%>
<%--                <a href="${APP_PATH}/role/toRole.html"><i class="glyphicon glyphicon-king"></i> 角色维护</a>--%>
<%--            </li>--%>
<%--            <li style="height:30px;">--%>
<%--                <a href="${APP_PATH}/permission/toPermissionPage.html"><i class="glyphicon glyphicon-lock"></i> 许可维护</a>--%>
<%--            </li>--%>
<%--        </ul>--%>
<%--    </li>--%>
<%--    <li class="list-group-item tree-closed">--%>
